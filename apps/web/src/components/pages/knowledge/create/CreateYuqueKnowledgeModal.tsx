...
import { HelpCircle, Sparkles, Bot, Image as ImageIcon, Feather, BookOpen } from "lucide-react"
import {
    Dialog,
    DialogContent,
    DialogHeader,
...
interface CreateYuqueKnowledgeModalProps {
    open: boolean
    onOpenChange: (open: boolean) => void
}

export default function CreateYuqueKnowledgeModal({ open, onOpenChange }: CreateYuqueKnowledgeModalProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px] p-0 gap-0 overflow-hidden">
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                        <div className="text-sm font-medium text-slate-900">
                            <span className="text-red-500 mr-1">*</span>User ID
                        </div>
                        <Input 
                            placeholder="User ID" 
                            value={userId}
                    ...
                    <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                        <div className="text-sm font-medium text-slate-900">
                            <span className="text-red-500 mr-1">*</span>Token
                        </div>
                        <Input 
                            placeholder="Token" 
                            value={token}
